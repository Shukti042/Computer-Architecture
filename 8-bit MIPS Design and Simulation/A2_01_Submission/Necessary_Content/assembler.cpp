...
int main() {
    ...
    inst_to_code["or"] = "0001";
    inst_to_code["bneq"] = "0010";
    inst_to_code["srl"] = "0011";
    inst_to_code["j"] = "0100";
    inst_to_code["nor"] = "0101";
    inst_to_code["andi"] = "0110";
    inst_to_code["beq"] = "0111";
    inst_to_code["sub"] = "1000";
    inst_to_code["sll"] = "1001";
    inst_to_code["lw"] = "1010";
    inst_to_code["addi"] = "1011";
    inst_to_code["sw"] = "1100";
    inst_to_code["and"] = "1101";
    inst_to_code["ori"] = "1110";
    inst_to_code["subi"] = "1111";
    ...
    while (getline(input_file, str)) {
        ...
        if (opcode == "add" or opcode == "sub" or opcode == "and" or opcode == "or"  or opcode == "nor") {
            ...
            output_file << inst_to_code[opcode] << "0000"<< register_addresses[rt] << register_addresses[rd]
             << to_binary_string(shift_amount, 4) << "\n";
